...
return ret;};var dY=dY||{};dY.dt={};dY.dt.year=1970;dY.dt.dateStringToDate=function(str){splt=str.split("  ");date=splt[0].trim().split("/");month=parseInt(date[0])-1
day=parseInt(date[1])
...
var a=Math.ceil(start);var b=Math.floor(end);this._=dY.dt.niceFormat(new Date(a*1000*60))+" -> "+dY.dt.niceFormat(new Date(b*1000*60))
...
this.duration=function(){return b-a;};this.durationHrs=function(){return Math.round((b-a)/60);};this.isHour=function(){return this.durationHrs()==1;};}
