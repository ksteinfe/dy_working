...
dY.dt.seasonTable=[{idx:0,fullname:"Winter"},{idx:1,fullname:"Spring"},{idx:2,fullname:"Summer"},{idx:3,fullname:"Fall"},]
...
this.season=function(){var mth=this.monthOfYear();if(mth==0||mth==1||mth==11)return dY.dt.seasonTable[0];if(mth==2||mth==3||mth==4)return dY.dt.seasonTable[1];if(mth==5||mth==6||mth==7)return dY.dt.seasonTable[2];if(mth==8||mth==9||mth==10)return dY.dt.seasonTable[3];};this.duration=function(){return b-a;};this.durationHrs=function(){return Math.round((b-a)/60);};this.isHour=function(){return this.durationHrs()==1;};}
